classdef test_plot_correlation_matrix < matlab.unittest.TestCase %#ok<*PROP>
    ...
    methods (Test)
        function test_normal(self)
            self.figs(end+1) = matspace.plotting.plot_correlation_matrix(self.data, self.labels, FigVisible=self.fig_visible);
        end
        ...
        function test_bad_nargin1(self)
            self.verifyError(@() matspace.plotting.plot_correlation_matrix(), 'MATLAB:minrhs');
        end
        ...
        function test_default_labels(self)
            self.figs(end+1) = matspace.plotting.plot_correlation_matrix(self.data(1:5, 1:3), FigVisible=self.fig_visible);
        end
        ...
        function test_symmetric(self)
            self.figs(end+1) = matspace.plotting.plot_correlation_matrix(self.sym, FigVisible=self.fig_visible);
        end
        ...
        function test_above_one(self)
            ...
            self.figs(end+1) = matspace.plotting.plot_correlation_matrix(large_data, self.labels, FigVisible=self.fig_visible);
        end
