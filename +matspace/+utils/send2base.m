...
%
%     % with wildcards
%     matspace.utils.send2base('name*');
%
%     % with exclusions
%     matspace.utils.send2base('test', 'name_one', 'name_two', '-exclude', '*two');
%
%     % send everything
%     matspace.utils.send2base('*');
%
%     % send everything, except for some common exceptions
%     matspace.utils.send2base('*', '-exclude', {'ans', 'obj', 'this', 'self'});
%
% Change Log:
