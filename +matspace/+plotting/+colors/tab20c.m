function [colors] = tab20c()

% TAB20C  is the tab20c colormap from Python matplotlib.
%
% Input:
%     (None)
%
...
% matspace.plotting.colors.get_python_colormap('tab20c')
colors = [...
     ...
     0.192156862745098          0.63921568627451         0.329411764705882
     ...
     0.854901960784314         0.854901960784314          0.92156862745098
