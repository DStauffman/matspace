...
%     [classification, caveat] = matspace.plotting.get_classification(classify);
%     assert(strcmp(classification, 'U'));
%     assert(strcmp(caveat, '//MADE UP CAVEAT'));
%
% See Also:
%     matspace.plotting.plot_classification
%
% Change Log:
