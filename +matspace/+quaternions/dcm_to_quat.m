...
%     q1  = matspace.quaternions.dcm_to_quat(dcm);
%     q2  = matspace.quaternions.dcm_to_quat(repmat(dcm,[1 1 5]));
%     q3  = matspace.quaternions.dcm_to_quat(repmat(dcm(:),[1 5]));
%
% See Also:
%     matspace.quaternions.quat_to_dcm
%
% Reference:
